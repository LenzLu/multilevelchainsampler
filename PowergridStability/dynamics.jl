...
function swing_dynamics!(dₜu, u, p::EnergyGrid ,t)
...
function solve_system(grid::EnergyGrid,  u₀; t_final=20.0)
    problem = ODEProblem(swing_dynamics!, u₀, (0.0, t_final), grid)
    solution = solve(problem, Rodas5P(); abstol=1e-6, reltol=1e-6)
...
function steady_state(grid::EnergyGrid)
